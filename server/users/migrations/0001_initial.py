# Generated by Django 2.0 on 2018-06-25 10:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_message', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.GroupMessage')),
            ],
        ),
        migrations.CreateModel(
            name='UserFriends',
        ...
        migrations.AddField(
            model_name='room',
            name='room_messages',
            field=models.ManyToManyField(through='users.RoomMessages', to='users.GroupMessage'),
        ),
        migrations.AddField(
            model_name='room',
            name='users',
            field=models.ManyToManyField(through='users.UserRooms', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
            name='friends',
            field=models.ManyToManyField(through='users.UserFriends', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddField(
            model_name='user',
            name='messages',
            field=models.ManyToManyField(through='users.UserMessages', to='users.Message'),
        ),
        migrations.AddField(
            model_name='user',
            name='rooms',
            field=models.ManyToManyField(through='users.UserRooms', to='users.Room'),
        ),
        migrations.AddField(
            model_name='user',
